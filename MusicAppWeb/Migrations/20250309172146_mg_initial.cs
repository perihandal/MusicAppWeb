    ...
    public partial class mg_initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReleaserCompanies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaserCompanyId = table.Column<int>(type: "int", nullable: true),
                    PictureBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Albums_ReleaserCompanies_ReleaserCompanyId",
                        column: x => x.ReleaserCompanyId,
                        principalTable: "ReleaserCompanies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_songListeningRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_songListeningRates_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Albums_ReleaserCompanyId",
                table: "Albums",
                column: "ReleaserCompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_songListeningRates_SongId",
                table: "songListeningRates",
                column: "SongId");
